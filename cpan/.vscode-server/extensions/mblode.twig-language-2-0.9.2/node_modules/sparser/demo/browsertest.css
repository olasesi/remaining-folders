...
h1 a{color:#c00}
.version{color:#070;float:right;font-size:1.6em;font-weight:bold;margin-top:-1.2em}
...
.options {max-width:45em}
.title{margin:0 0 0.5em;min-width:35em}
.navigation{min-width:15em}
.keybox ul{padding:0}
.options ul,
.navigation ul{list-style-position:inside;margin:0;padding:0}
.options li,
.navigation li{padding:0.6em 0 0}
.clear{clear:both;display:block;float:none;height:0.01em}
.ace-control{display:inline-block;margin:0}
#datatext,
...
.keybox,
.options,
.navigation{background:#fff;border:0.1em solid #ccc;box-shadow:0.21em 0.21em 0.42em #ddd;float:left;height:12em;margin:0 1em 1em 0;padding:0.5em 0.5em 0;position:relative}
#datatext,
#data{border:0.1em solid #bbb;box-shadow:0.21em 0.21em 0.42em #888}
#datatext{background:#eee;}
#data{background:#ddd}
...
#options{background:#f8f8f8;border:0.0715em solid #bbb;box-shadow:0.15em 0.15em 0.3em 0 #888;margin-top:1em;padding:1em}
#options ul{list-style-position:inside;padding:0}
#options li{list-style:none;border-bottom:0.1em solid #bbb;margin:1em 0 0}
#options td span{display:block}
#options .option-usage span{padding:0 0 0.5em}
#options .option-description span{padding:0.5em 0.5em 0}
#options .option-description code{text-decoration:underline}
#options .option-name{color:#c00;font-weight:bold}
#options select,
#options input{font-family:inherit;font-weight:bold}
#options table{margin:1em 0}
#options td,
#options th{border-style:none}
#options th{padding-right:2em;text-align:left;vertical-align:top}
...
div[class="input"] textarea{background:#f8f8f8}
