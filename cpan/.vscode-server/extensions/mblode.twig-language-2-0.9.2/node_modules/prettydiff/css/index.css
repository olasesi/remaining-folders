...
#prettydiff .contentarea{border-style:solid;border-width:0.1em;font-family:"Century Gothic","Trebuchet MS";margin:0 auto;max-width:93em;padding:1em;position:relative;text-align:left}
...
#prettydiff #documentation code{border-style:none;white-space:pre}
...
/*global - headings*/
#prettydiff h1{font-size:3em;font-weight:normal;margin-top:0;width:22em}
...
#prettydiff #dcolorScheme{margin:0;position:absolute;right:0.6em;top:0.5em}
...
/*reports.css*/
#prettydiff #report.contentarea{font-family:"Lucida Sans Unicode","Helvetica","Arial",sans-serif;max-width:none;overflow:scroll}
...
#prettydiff #report th{font-family:"Lucida Sans Unicode","Helvetica","Arial",sans-serif;font-size:1.2em}
...
#prettydiff .report .analysis .parseData td{font-family:'Courier New',Courier,'Lucida Console',monospace;text-align:left;white-space:pre}
...
#prettydiff .diffcli{font-size:Courier,'Courier New','Lucida Console',monospace;margin:0;padding:0;text-align:left;white-space:pre;}
...
#prettydiff .diffcli ins{display:block;font-family:Courier,'Courier New','Lucida Console',monospace;font-size:1.2em;font-style:normal;margin:0;text-decoration:none}
...
#prettydiff .diff,
#prettydiff .beautify{border-style:solid;border-width:0.1em;display:inline-block;margin:0 1em 1em 0;position:relative}
#prettydiff .diff,
#prettydiff .diff li
#prettydiff .diff h3,
#prettydiff .diff h4,
...
#prettydiff .beautify h4{font-family:'Courier New',Courier,'Lucida Console',monospace}
#prettydiff .diff li,
#prettydiff .beautify li,
#prettydiff .diff h3,
#prettydiff .diff h4,
#prettydiff .beautify h3,
#prettydiff .beautify h4{border-style:none none solid none;border-width:0 0 0.1em 0;box-shadow:none;display:block;font-size:1.2em;margin:0 0 0 -.1em;padding:0.2em 2em;text-align:left}
#prettydiff .diff .skip{border-style:none none solid;border-width:0 0 0.1em}
#prettydiff .diff .diff-left{border-style:none;display:table-cell}
#prettydiff .diff .diff-right{border-style:none none none solid;border-width:0 0 0 0.1em;display:table-cell;margin-left:-.1em;min-width:16.5em;right:0;top:0}
...
#prettydiff .beautify h3{font-size:1.2em}
#prettydiff .diff li em,
#prettydiff .beautify li em{font-style:normal;font-weight:bold;margin:-0.5em -0.09em}
#prettydiff .diff p.author{border-style:solid;border-width:0.2em 0.1em 0.1em;margin:0;overflow:hidden;padding:0.4em;text-align:right}
#prettydiff .difflabel{display:block;height:0}
#prettydiff .count{border-style:solid;border-width:0 0.1em 0 0;font-weight:normal;padding:0;text-align:right}
...
#prettydiff .beautify .data span{display:inline-block;font-style:normal;font-weight:bold}
#prettydiff .beautify li,
#prettydiff .diff li{border-style:none none solid;border-width:0 0 0.1em;display:block;height:1em;line-height:1.2;list-style-type:none;margin:0;white-space:pre}
#prettydiff .beautify ol,
#prettydiff .diff ol{display:table-cell;margin:0;padding:0}
#prettydiff .beautify li em{border-style:none none solid;border-width:0 0 0.1em;padding:0 0 0.2em;position:relative;z-index:5}
#prettydiff .beautify li .line{border-style:none}
#prettydiff .beautify li span{border-style:none none solid;border-width:0 0 0.1em;height:2em;margin:0 0 -1em;position:relative;top:-0.5em}
#prettydiff .beautify span.l0{margin-left:-0.5em;padding-left:0.5em}
...
#prettydiff #report .diff li{font-family:"Courier New",Courier,"Lucida Console",monospace}
#prettydiff #report .beautify{border-style:solid}
#prettydiff #report .diff h3,
#prettydiff #report .beautify h3{border-top-style:solid;border-top-width:0.1em;margin:0}
...
/*documentation.css*/
/*documentation - table of contents (guide pages)*/
#prettydiff #doc_contents a{text-decoration:none}
#prettydiff #doc_contents ol{padding-bottom:1em}
#prettydiff #doc_contents ol ol li{font-size:0.75em;list-style:lower-alpha;margin:0.5em 0 1em 3em}
#prettydiff #doc_contents ol ol{background-color:inherit;border-style:none;margin:0.25em 0.3em 0 0;padding-bottom:0}

/*documentation - files by date at bottom*/
#prettydiff .segment {border-collapse:collapse;border-style:solid;border-width:0.1em;margin:0 0 1em;padding:1em}
#prettydiff ol.segment{list-style-position:inside}
#prettydiff ol.segment ul{padding:0 0 0 4em}
#prettydiff ol.segment li {border-style:none none dashed;border-width:0 0 0.1em;margin:0 0 1.5em;padding:0 0 0.5em}
#prettydiff ol.segment ul li {border-style:none;list-style-type:none;margin:0 0 1em;padding:0}
#prettydiff ol.segment h4{display:inline}
#prettydiff ol.segment h5{margin:0.5em 0 0 -2em}
#prettydiff th.date,
#prettydiff td.date{width:7.5em}

/*documentation - showing content normally hidden from visual users*/
#prettydiff .content-show {height:auto;position:static;width:auto}
#prettydiff #documentation code{font-size:1em}
#prettydiff #documentation li#report{background:transparent;line-height:inherit}
#prettydiff #documentation li dt,
#prettydiff #documentation li dd,
#prettydiff #documentation li#report li,
#prettydiff #documentation li#report h4{font-family:inherit;font-size:1em}
#prettydiff #documentation li li em {font-weight:bold}
#prettydiff #documentation #options ul {padding: 0 0 0 2em}
#prettydiff #documentation #options ul li {padding: 0 0 0 2em}
#prettydiff #documentation .doc-version span{display:block}
#prettydiff #documentation h4{border-style:none none solid;border-width:0.1em}


/*page_specific.css*/
/*samples - layout for samples page*/
#prettydiff #pdsamples{list-style-position:inside;margin:0;padding:1em;position:relative;z-index:10}
#prettydiff #pdsamples > li{border-style:none none dashed;border-width:0 0 0.1em;margin:0 0 1em}
#prettydiff #pdsamples li div{border-style:solid;border-width:0.05em;margin:0;padding:1em}
#prettydiff #pdsamples li p{display:inline-block;font-size:1em;margin:0}
#prettydiff #pdsamples li p a{display:block;margin:0 0 1em 2em}
#prettydiff #pdsamples li ul{margin:0 0 0 2em;padding:0}

#prettydiff #page h1{width:22.5em}
#prettydiff #samples h2,
#prettydiff #page h2{font-size:2em}
#prettydiff #page > div{border-style:none}
#prettydiff #page textarea{font-size:1.6em}
#prettydiff #page code{border-width:0.05em;font-size:1.6em;white-space:pre}
#prettydiff #page li code{font-size:1em}
#prettydiff #page .beautify{font-size: 1.2em}
#prettydiff #page li .beautify{font-size:0.75em}
...
#prettydiff.white .ace-tm .ace_marker-layer .ace_selected-word{background:#ff9}
...
#prettydiff.white #page #input,
#prettydiff.white #output{border-color:#999}
...
#prettydiff.white #webtool td.nested .header th,
#prettydiff.white #webtool .header th{background:#eef}
#prettydiff.white #webtool thead th{background:#eef}
#prettydiff.white #webtool .readonly .ace_scroller,
#prettydiff.white #webtool td.nested th{background:#eee}
#prettydiff.white #textareaTabKey em{color:#00f}
#prettydiff.white #announcement strong,
#prettydiff.white #textareaTabKey strong{color:#b00}
#prettydiff.white #announcement em,
...
#prettydiff.white .readonly .ace-tm .ace_indent-guide {background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXd3d3u346CAAAACklEQVR4nGNgAAAAAgABSK+kcQAAAABJRU5ErkJggg==") right repeat-y;}
#prettydiff.white .ace_print-margin{background:#ccc}
#prettydiff.white .donate a{background:#fea}
...
#prettydiff.canvas #page #input,
#prettydiff.canvas #output{border-color:#999}
...
#prettydiff.canvas .ace_gutter{background:#ccccc8;border-color:#999;color:#333}
...
#prettydiff.canvas .ace_selection.ace_start.ace_br15{background:#ff6}
#prettydiff.canvas .unchecked{background:#eeeee8}
#prettydiff.canvas #announcement em,
#prettydiff.canvas #textareaTabKey em{color:#060}
#prettydiff.canvas #announcement strong,
#prettydiff.canvas #textareaTabKey strong{color:#900}
#prettydiff.canvas #webtool .readonly .ace_scroller,
...
#prettydiff.canvas #webtool .readonly textarea{background:#bbbbb8}
...
#prettydiff.canvas .donate a{background:#eda}

/*ace theme colors - canvas*/
#prettydiff.canvas .ace_print-margin{background:#bbb}
#prettydiff.canvas .ace-canvas .ace_identifier{color:#930;}
#prettydiff.canvas .ace-canvas .ace_fold {background-color: #6B72E6;}
#prettydiff.canvas .ace-canvas {background-color: #e8e8e8;color: black;}
#prettydiff.canvas .ace-canvas .ace_cursor {color: black;}
#prettydiff.canvas .ace-canvas .ace_invisible {color: rgb(191, 191, 191);}
#prettydiff.canvas .ace-canvas .ace_storage,.ace-canvas .ace_keyword {color: #660;}
#prettydiff.canvas .ace-canvas .ace_constant {color: rgb(197, 6, 11);}
#prettydiff.canvas .ace-canvas .ace_constant.ace_buildin {color: rgb(88, 72, 246);}
#prettydiff.canvas .ace-canvas .ace_constant.ace_language {color: rgb(88, 92, 246);}
#prettydiff.canvas .ace-canvas .ace_constant.ace_library {color: #390;}
#prettydiff.canvas .ace-canvas .ace_invalid {background-color: rgba(255, 0, 0, 0.1);color: red;}
#prettydiff.canvas .ace-canvas .ace_support.ace_function {color: rgb(60, 76, 114);}
#prettydiff.canvas .ace-canvas .ace_support.ace_constant {color: #390;}
#prettydiff.canvas .ace-canvas .ace_support.ace_type,.ace-canvas .ace_support.ace_class {color: rgb(109, 121, 222);}
#prettydiff.canvas .ace-canvas .ace_keyword.ace_operator {color: rgb(104, 118, 135);}
#prettydiff.canvas .ace-canvas .ace_string {color: rgb(3, 106, 7);}
#prettydiff.canvas .ace-canvas .ace_comment {color: rgb(76, 136, 107);}
#prettydiff.canvas .ace-canvas .ace_comment.ace_doc {color: rgb(0, 102, 255);}
#prettydiff.canvas .ace-canvas .ace_comment.ace_doc.ace_tag {color: rgb(128, 159, 191);}
#prettydiff.canvas .ace-canvas .ace_constant.ace_numeric {color: rgb(0, 0, 205);}
#prettydiff.canvas .ace-canvas .ace_variable {color: rgb(49, 132, 149);}
#prettydiff.canvas .ace-canvas .ace_xml-pe {color: rgb(104, 104, 91);}
#prettydiff.canvas .ace-canvas .ace_entity.ace_name.ace_function {color: #0000A2;}
#prettydiff.canvas .ace-canvas .ace_heading {color: rgb(12, 7, 255);}
#prettydiff.canvas .ace-canvas .ace_list {color:rgb(185, 6, 144);}
#prettydiff.canvas .ace-canvas .ace_meta.ace_tag {color:rgb(0, 22, 142);}
#prettydiff.canvas .ace-canvas .ace_string.ace_regex {color: rgb(255, 0, 0)}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_selection {background: rgb(181, 213, 255);}
#prettydiff.canvas .ace-canvas.ace_multiselect .ace_selection.ace_start {box-shadow: 0 0 3px 0px white;border-radius: 2px;}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_step {background: rgb(252, 255, 0);}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_stack {background: rgb(164, 229, 101);}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_bracket {margin: -1px 0 0 -1px;border: 1px solid rgb(192, 192, 192);}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_active-line {background: rgba(0, 0, 0, 0.07);}
#prettydiff.canvas .ace-canvas .ace_gutter-active-line {background-color : #dcdcdc;}
#prettydiff.canvas .ace-canvas .ace_marker-layer .ace_selected-word {background: rgb(250, 250, 255);border: 1px solid rgb(200, 200, 250);}
#prettydiff.canvas .ace-tm .ace_indent-guide {background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAE0lEQVQImWP4////f4bLly//BwAmVgd1/w11/gAAAABJRU5ErkJggg==") right repeat-y;}
...
#prettydiff.shadow #input,
#prettydiff.shadow #input.ace_editor,
#prettydiff.shadow #output.ace_editor{border-color:#666}
#prettydiff.shadow #page #input,
#prettydiff.shadow #output{border-color:#666}
#prettydiff.shadow #textareaTabKey,
...
#prettydiff.shadow .ace_selection.ace_start,
#prettydiff.shadow .ace_selected-word{background:#990;color:#333}
#prettydiff.shadow .ace-tm .ace_marker-layer .ace_selection,
#prettydiff.shadow .ace-canvas .ace_marker-layer .ace_selection,
#prettydiff.shadow .ace_selection.ace_start.ace_br15{background:#666}
#prettydiff.shadow .ace_comment{color:#ce9}
#prettydiff.shadow .ace_variable{color:#cef}
#prettydiff.shadow .ace_active-line{background:#333}
#prettydiff.shadow .ace-idle-fingers .ace_keyword,
#prettydiff.shadow .ace-idle-fingers .ace_meta,
#prettydiff.shadow .ace-idle-fingers .ace_type{color:#ea6}
#prettydiff.shadow .ace-idle-fingers .ace_identifier,
#prettydiff.shadow .ace-idle-fingers .ace_variable{color:#ddd}
#prettydiff.shadow .ace-idle-fingers .ace_constant,
#prettydiff.shadow .ace-idle-fingers .ace_constant.ace_character,
#prettydiff.shadow .ace-idle-fingers .ace_constant.ace_character.ace_escape,
#prettydiff.shadow .ace-idle-fingers .ace_constant.ace_other,
#prettydiff.shadow .ace-idle-fingers .ace_support.ace_constant{color:#8cc9fb}
#prettydiff.shadow .unchecked{background:#666}
#prettydiff.shadow #textareaTabKey em{color:#cf3}
#prettydiff.shadow #webtool .readonly .ace_scroller,
#prettydiff.shadow .box .body{background:#222}
#prettydiff.shadow #announcement em,
#prettydiff.shadow .box .body p em{color:#cf3}
#prettydiff.shadow #announcement strong,
...
#prettydiff.shadow .readonly .ace_active-line{background:#333}
#prettydiff.shadow .ace_print-margin{background:#777}
#prettydiff.shadow .donate a{background:#653;color:#db0}

#prettydiff #security-warning{background:#fcc;border:0.2em solid #f00;font-family:"Century Gothic", "Trebuchet MS";padding:1em;text-align:left}
#prettydiff #security-warning h1{margin:0}
#prettydiff #security-warning h2{font-size:2em;margin-bottom:0.5em}
#prettydiff #security-warning code{background:#fee;border:0.1em solid #f99;font-family:monospace;font-size:1.5em;padding:0.5em;white-space:pre;width:auto}
...
#prettydiff .ace_print-margin-layer{z-index:6}

/*webtool - webtool page element*/
#prettydiff #webtool.contentarea{box-shadow:none;max-width:100%}
#prettydiff #loadmask{display:block;font-size:10em;text-align:center;width:100%}

/*webtool - footer*/
#prettydiff #footer{padding:0 1em}

/*webtool - ace slider arrow*/
#prettydiff #slider{display:block;font-size:0.835em;line-height:1;margin:0;padding:0;position:relative}
#prettydiff #slider span{cursor:ew-resize;display:inline-block;font-family:"Courier New",Courier,"Lucida Console",monospace;position:absolute;top:-1.4em}
#prettydiff #slider button{background:transparent;border-style:none;box-shadow:none;cursor:ew-resize;display:inline;font-size:1.4em;margin:0;padding:0}

/*webtool - headings*/
#prettydiff #loadmask span{background:none;display:block;text-align:center;}
#prettydiff #loadmask svg{border-style:none;float:none;height:5em;opacity:0.15;width:5em}
...
#prettydiff #webtool th{font-family:"Lucida Sans Unicode","Helvetica","Arial",sans-serif;font-size:1.2em;letter-spacing:0.05em}
...
#prettydiff #webtool .comment-container{border-style:none;padding-bottom:0}
...
#prettydiff #infolinks li{display:inline-block;font-size:1.4em;list-style:none;margin:0.75em 1em 0}
#prettydiff .donate a{border-radius:0.25em;border-style:none;color:#111;font-weight:bold;padding:0.25em}
#prettydiff .donate svg{margin:0 0 -0.25em;position:relative;z-index:2}

/*webtool - minor notifications that appear after a code operation directly next to "[mode] Code" heading*/
#prettydiff #announcement{height:auto;left:14em;margin:0;overflow:hidden;position:absolute;text-overflow:ellipsis;white-space:nowrap;width:40%;z-index:5}
#prettydiff #announcement strong.duplicate{display:block}
#prettydiff #announcement span{display:block}
...
#prettydiff #analysisops p strong,
#prettydiff #options .label,
#prettydiff #diffops .label,
#prettydiff #miniops .label,
#prettydiff #beauops .label,
#prettydiff #parseops .label,
#prettydiff #analysisops .label{display:block;float:none;font-size:1em;font-weight:bold;margin-bottom:0.5em}
...
#prettydiff #webtool .readonly,
#prettydiff #webtool .output{clear:none;width:49%}
#prettydiff #webtool .input{float:left}
#prettydiff #webtool .output,
#prettydiff #webtool .readonly{float:right}
#prettydiff #webtool .output textarea,
#prettydiff #webtool .readonly{margin-left:-0.2em}

/*webtool - labels to textareas for code input/output*/
#prettydiff #webtool .input label,
#prettydiff #webtool .readonly label,
#prettydiff #webtool .output label{display:inline-block;font-weight:bold}

/*webtool - file input*/
#prettydiff p.file{clear:none;float:none;margin:0.5em 0 1em}
...
#prettydiff #codeInput h2{display:block}
#prettydiff #codeInput .inputLabel{margin-bottom:0}
...
#prettydiff #webtool .option-description{font-size:1em;margin:-1.6em 0 0 29em}
#prettydiff #webtool .option-description span{display:block}
#prettydiff .options p.button{margin:0 0 1em}
#prettydiff .options span{display:inline-block;min-width:16.5em}
#prettydiff .options span label,
#prettydiff .options span input{display:inline;font-weight:normal;margin:0}
#prettydiff .options p{margin:0}
#prettydiff .options label,
#prettydiff #options p.label,
#prettydiff #addOptions p.label{display:block;font-size:1em;font-weight:bold;margin:0 0 1em -1em}
#prettydiff .options ul{margin:0 -1em;padding:0}
#prettydiff .options li{border-style:dashed;border-width:0 0 0.1em;list-style:none;margin:0;padding:1em 2em;position:relative}
#prettydiff #addOptions li .disabled{border-style:none;font-weight:bold;height:100%;left:0;opacity:0.5;position:absolute;text-align:right;top:0;width:100%;z-index:5;}
#prettydiff #addOptions a.apiname,
#prettydiff #options span.apiname{float:left;font-weight:normal;margin:0 -80em 0 30em;padding:0}
#prettydiff .resetbutton{padding:0}
#prettydiff #resetOptions{margin:-2em 0.65em -6em 0}
...
#prettydiff .options input[type=text]{margin-right:1em;width:13.1em}
#prettydiff p button,
...
#prettydiff #update{clear:both;float:right;margin:0;padding:0.25em;position:absolute;right:0;top:0;z-index:2;}
#prettydiff #update strong{display:block;float:right}
#prettydiff #update span{clear:both;display:block}
...
#prettydiff #webtool #statreport{display:none}


/*media.css*/
@media print{
    #prettydiff div{width:100%}
    #prettydiff #webtool td{font-size:0.8em;white-space:normal}
    #prettydiff #webtool p,
    #prettydiff .options,
    #prettydiff #webtool ul,
    #prettydiff ul{display:none}
}
@media (max-width: 1000px) {
    #prettydiff #functionGroup{height:4em}
    #prettydiff #webtool #infolinks{float:left;margin:4em 0 -8em;padding:0}
}
@media (max-width: 640px){
    #prettydiff #codeInput label{display:none}
    #prettydiff #diffBase,
    #prettydiff #diffNew{width:46%}
    #prettydiff #dcolorScheme{margin:0 0 1em}
    #prettydiff #functionGroup span{margin-left:0.5em;position:relative;z-index:10}
    #prettydiff #infolinks{margin:0}
    #prettydiff #reports{display:none}
    #prettydiff #update{margin-top:2.75em}
    #prettydiff .labeltext input,
    #prettydiff .file input{width:12em}
}
@media (max-width: 575px) {
    #prettydiff #webtool #functionGroup{height:6em}
    #prettydiff #webtool #functionGroup span{height: 2.5em}
    #prettydiff #webtool #infolinks{float:left;margin:6em 0 -12em;padding:0}
    #prettydiff #webtool .apiname,
    #prettydiff #webtool .option-description{display:none}
}
