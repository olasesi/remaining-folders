...
mocha_1.describe('Extract Abbreviations', () => {
    mocha_1.it('should extract abbreviations from document html', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            ...
            assert_1.default.equal(expectedAbbr, abbreviation);
            assert_1.default.equal(expectedRangeStartLine, abbreviationRange.start.line);
            assert_1.default.equal(expectedRangeStartChar, abbreviationRange.start.character);
            assert_1.default.equal(expectedRangeEndLine, abbreviationRange.end.line);
            assert_1.default.equal(expectedRangeEndChar, abbreviationRange.end.character);
            assert_1.default.equal(filter, expectedFilter);
        });
    });
    mocha_1.it('should extract abbreviations from document css', () => {
        ...
        testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedRangeStartLine, expectedRangeStartChar, expectedRangeEndLine, expectedRangeEndChar, expectedFilter]) => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, content);
            const position = vscode_languageserver_types_1.Position.create(positionLine, positionChar);
            const { abbreviationRange, abbreviation, filter } = emmetHelper_1.extractAbbreviation(document, position, { syntax: 'css', lookAhead: false });
            assert_1.default.equal(expectedAbbr, abbreviation);
            assert_1.default.equal(expectedRangeStartLine, abbreviationRange.start.line);
            assert_1.default.equal(expectedRangeStartChar, abbreviationRange.start.character);
            assert_1.default.equal(expectedRangeEndLine, abbreviationRange.end.line);
...
mocha_1.describe('Test Basic Expand Options', () => {
    mocha_1.it('should check for basic expand options', () => {
        ...
        assert_1.default.equal(expandOptions.field, emmetHelper_1.emmetSnippetField);
        assert_1.default.equal(expandOptions.syntax, syntax);
        assert_1.default.equal(Object.keys(expandOptions.addons).length, 0);
    });
});
mocha_1.describe('Test addons in Expand Options', () => {
    mocha_1.it('should add jsx as addon for jsx syntax', () => {
        const syntax = 'jsx';
        let expandOptions = emmetHelper_1.getExpandOptions(syntax);
        assert_1.default.equal(Object.keys(expandOptions.addons).length, 1);
        assert_1.default.equal(expandOptions.addons['jsx'], true);
    });
    mocha_1.it('should add bem as addon when bem filter is provided', () => {
        const syntax = 'anythingreally';
        let expandOptions = emmetHelper_1.getExpandOptions(syntax, {}, 'bem');
        assert_1.default.equal(Object.keys(expandOptions.addons).length, 1);
        assert_1.default.equal(expandOptions.addons['bem']['element'], '__');
    });
    mocha_1.it('should add bem before jsx as addon when bem filter is provided', () => {
        const syntax = 'jsx';
        let expandOptions = emmetHelper_1.getExpandOptions(syntax, {}, 'bem');
        assert_1.default.equal(Object.keys(expandOptions.addons).length, 2);
        assert_1.default.equal(Object.keys(expandOptions.addons)[0], 'bem');
        assert_1.default.equal(Object.keys(expandOptions.addons)[1], 'jsx');
        assert_1.default.equal(expandOptions.addons['bem']['element'], '__');
        assert_1.default.equal(expandOptions.addons['jsx'], true);
    });
});
mocha_1.describe('Test output profile settings', () => {
    mocha_1.it('should convert output profile from old format to new', () => {
        ...
        assert_1.default.equal(profile['tag_case'], expandOptions.profile['tagCase']);
        assert_1.default.equal(profile['attr_case'], expandOptions.profile['attributeCase']);
        assert_1.default.equal(profile['attr_quotes'], expandOptions.profile['attributeQuotes']);
        assert_1.default.equal(profile['tag_nl'], expandOptions.profile['format']);
        assert_1.default.equal(profile['inline_break'], expandOptions.profile['inlineBreak']);
        assert_1.default.equal(profile['self_closing_tag'], expandOptions.profile['selfClosingStyle']);
    });
    mocha_1.it('should convert self_closing_style', () => {
        ...
        for (let i = 0; i < testCases.length; i++) {
            ...
            assert_1.default.equal(expandOptions.profile['selfClosingStyle'], expectedValue[i]);
        }
    });
    mocha_1.it('should convert tag_nl', () => {
        ...
        for (let i = 0; i < testCases.length; i++) {
            ...
            assert_1.default.equal(expandOptions.profile['format'], expectedValue[i]);
        }
    });
    mocha_1.it('shoud use output profile in new format as is', () => {
        ...
        Object.keys(profile).forEach(key => {
            assert_1.default.equal(expandOptions.profile[key], profile[key]);
        });
    });
    mocha_1.it('should use profile from settings that overrides the ones from extensionsPath', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            ...
            const expandOptions = emmetHelper_1.getExpandOptions('html', { syntaxProfiles: { html: profile } });
            assert_1.default.equal(expandOptions.profile['tagCase'], 'lower');
            assert_1.default.equal(profile['tag_case'], 'lower');
...
mocha_1.describe('Test variables settings', () => {
    mocha_1.it('should take in variables as is', () => {
        ...
        Object.keys(variables).forEach(key => {
            assert_1.default.equal(expandOptions.variables[key], variables[key]);
        });
    });
    mocha_1.it('should use variables from extensionsPath', () => {
        updateExtensionsPath(extensionsPath).then(() => {
            ...
            assert_1.default.equal(expandOptions.variables['lang'], 'fr');
        });
    });
    mocha_1.it('should use given variables that override ones from extensionsPath', () => {
        updateExtensionsPath(extensionsPath).then(() => {
            const variables = {
                lang: 'en',
                charset: 'UTF-8'
            ...
            const expandOptions = emmetHelper_1.getExpandOptions('html', { variables });
            assert_1.default.equal(expandOptions.variables['lang'], variables['lang']);
        });
    });
});
mocha_1.describe('Test custom snippets', () => {
    mocha_1.it('should use custom snippets for given syntax from extensionsPath', () => {
        ...
        return updateExtensionsPath(null).then(() => {
            ...
            return updateExtensionsPath(extensionsPath).then(() => {
                ...
                assert_1.default.equal(foundCustomSnippet, true);
                return Promise.resolve();
            });
        });
    });
    mocha_1.it('should use custom snippets inherited from base syntax from extensionsPath', () => {
        const customSnippetKey = 'ch';
        return updateExtensionsPath(null).then(() => {
            ...
            return updateExtensionsPath(extensionsPath).then(() => {
                ...
                assert_1.default.equal(foundCustomSnippet, true);
                assert_1.default.equal(foundCustomSnippetInInhertitedSyntax, true);
                return Promise.resolve();
            });
        });
    });
    mocha_1.it('should use custom snippets for given syntax in the absence of base syntax from extensionsPath', () => {
        const customSnippetKey = 'ch';
        return updateExtensionsPath(null).then(() => {
            const expandOptionsWithoutCustomSnippets = emmetHelper_1.getExpandOptions('scss');
            assert_1.default(!expandOptionsWithoutCustomSnippets.snippets);
    ...
    mocha_1.it('should throw error when snippets file from extensionsPath has invalid json', () => {
        ...
        return updateExtensionsPath(path.join(path.normalize(path.join(__dirname, '../../..')), 'testData', 'custom-snippets-invalid-json')).then(() => {
            assert_1.default.ok(false, 'updateExtensionsPath method should have failed for invalid json but it didnt');
            return Promise.resolve();
        }, (e) => {
    ...
    mocha_1.it('should reset custom snippets when no extensionsPath is given', () => {
        const customSnippetKey = 'ch';
        return updateExtensionsPath(extensionsPath).then(() => {
            let foundCustomSnippet = false;
            emmetHelper_1.getExpandOptions('scss').snippets.all({ type: 'string' }).forEach(snippet => {
                if (snippet.key === customSnippetKey) {
                    foundCustomSnippet = true;
                }
            });
            ...
            return updateExtensionsPath(null).then(() => {
                ...
                assert_1.default.ok(!e, 'When extensionsPath is not given, there shouldnt be any error.');
            });
        });
    });
});
mocha_1.describe('Test emmet preferences', () => {
    mocha_1.it('should use stylesheet preferences', () => {
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.propertyEnd': ';;' } })), 'margin: 10px;;');
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10', emmetHelper_1.getExpandOptions('scss', { preferences: { 'scss.valueSeparator': '::' } })), 'margin::10px;');
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10', emmetHelper_1.getExpandOptions('less', { preferences: { 'css.intUnit': 'pt' } })), 'margin: 10pt;');
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10.2', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.floatUnit': 'ex' } })), 'margin: 10.2ex;');
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10r', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.unitAliases': 'e:em, p:%,r: /rem' } })), 'margin: 10 /rem;');
        assert_1.default.equal(emmetHelper_1.expandAbbreviation('m10p', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.unitAliases': 'e:em, p:%,r: /rem' } })), 'margin: 10%;');
    });
});
mocha_1.describe('Test filters (bem and comment)', () => {
    mocha_1.it('should expand haml', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('ul[data="class"]', emmetHelper_1.getExpandOptions('haml', {})), '%ul(data="class")${0}');
            return Promise.resolve();
        });
    });
    mocha_1.it('should expand attributes with []', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('div[[a]="b"]', emmetHelper_1.getExpandOptions('html', {})), '<div [a]="b">${0}</div>');
            return Promise.resolve();
        });
    });
    mocha_1.it('should expand abbreviations that are nodes with no name', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('c', emmetHelper_1.getExpandOptions('html', {})), '<!-- ${0} -->');
            return Promise.resolve();
        });
    });
    mocha_1.it('should use filters from expandOptions', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation(bemFilterExample, emmetHelper_1.getExpandOptions('html', {}, 'bem')), expectedBemFilterOutput);
            assert_1.default.equal(emmetHelper_1.expandAbbreviation(commentFilterExample, emmetHelper_1.getExpandOptions('html', {}, 'c')), expectedCommentFilterOutput);
            assert_1.default.equal(emmetHelper_1.expandAbbreviation(bemCommentFilterExample, emmetHelper_1.getExpandOptions('html', {}, 'bem,c')), expectedBemCommentFilterOutput);
            return Promise.resolve();
        });
    });
    mocha_1.it('should use filters from syntaxProfiles', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation(bemFilterExample, emmetHelper_1.getExpandOptions('html', {
                syntaxProfiles: {
                    html: {
                        filters: 'html, bem'
                    }
            ...
            assert_1.default.equal(emmetHelper_1.expandAbbreviation(commentFilterExample, emmetHelper_1.getExpandOptions('html', {
                syntaxProfiles: {
                    html: {
                        filters: 'html, c'
                    }
...
mocha_1.describe('Test completions', () => {
    mocha_1.it('should provide multiple common tags completions in html', () => {
        return updateExtensionsPath(null).then(() => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, 'd');
            ...
            assert_1.default.ok(expectedItems.every(x => !!completionList.items.find(y => y.label === x)), 'All common tags starting with d not found');
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide multiple snippet suggestions in html', () => {
        return updateExtensionsPath(null).then(() => {
    ...
    mocha_1.it('should not provide any suggestions in html for class names or id', () => {
        return updateExtensionsPath(null).then(() => {
            ...
            testCases.forEach(abbr => {
                const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, abbr);
    ...
    mocha_1.it('should provide multiple snippet suggestions in html for nested abbreviations', () => {
        return updateExtensionsPath(null).then(() => {
    ...
    mocha_1.it('should provide completions html', () => {
        return updateExtensionsPath(null).then(() => {
            ...
            testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedExpansionDocs, expectedExpansion]) => {
                ...
                assert_1.default.equal(completionList.items[0].label, expectedAbbr);
                assert_1.default.equal(completionList.items[0].documentation, expectedExpansionDocs);
                assert_1.default.equal(completionList.items[0].textEdit.newText, expectedExpansion);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions css', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['trf', 'transform: ;'],
            ...
            testCases.forEach(([abbreviation, expected]) => {
                const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.css', 'css', 0, abbreviation);
                ...
                assert_1.default.equal(completionList.items[0].label, expected);
                assert_1.default.equal(completionList.items[0].filterText, abbreviation);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide hex color completions css', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['#1', '#111111'],
                ['#ab', '#ababab'],
    ...
    mocha_1.it('should provide empty incomplete completion list for abbreviations that just have the vendor prefix', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['-', 0, 1],
                ['-m-', 0, 3],
            ...
            testCases.forEach(([abbreviation, positionLine, positionChar]) => {
                ...
                assert_1.default.equal(completionList.items.length, 0, completionList.items.length ? completionList.items[0].label : 'all good');
                assert_1.default.equal(completionList.isIncomplete, true);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions for text that are prefix for snippets, ensure $ doesnt get escaped', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['<div> l </div>', 0, 7]
            ];
            testCases.forEach(([content, positionLine, positionChar]) => {
                ...
                assert_1.default.equal(completionList.items.find(x => x.label === 'link').documentation, '<link rel="stylesheet" href="|">');
                assert_1.default.equal(completionList.items.find(x => x.label === 'link').textEdit.newText, '<link rel="stylesheet" href="${0}">');
                assert_1.default.equal(completionList.items.find(x => x.label === 'link:css').documentation, '<link rel="stylesheet" href="style.css">');
                assert_1.default.equal(completionList.items.find(x => x.label === 'link:css').textEdit.newText, '<link rel="stylesheet" href="${2:style}.css">');
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions with escaped $ in scss', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['bim$hello', 0, 9]
            ];
            testCases.forEach(([content, positionLine, positionChar]) => {
                const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.scss', 'scss', 0, content);
                const position = vscode_languageserver_types_1.Position.create(positionLine, positionChar);
                ...
                assert_1.default.equal(completionList.items.find(x => x.label === 'background-image: $hello;').documentation, 'background-image: $hello;');
                assert_1.default.equal(completionList.items.find(x => x.label === 'background-image: $hello;').textEdit.newText, 'background-image: \\$hello;');
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions with escaped $ in html', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
            ...
            testCases.forEach(([content, positionLine, positionChar, expectedDoc, expectedSnippetText]) => {
                ...
                assert_1.default.equal(completionList.items.find(x => x.label === content).documentation, expectedDoc);
                assert_1.default.equal(completionList.items.find(x => x.label === content).textEdit.newText, expectedSnippetText);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions using custom snippets html', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            const testCases = [
            ...
            testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedExpansion]) => {
                ...
                assert_1.default.equal(completionList.items[0].label, expectedAbbr);
                assert_1.default.equal(completionList.items[0].documentation, expectedExpansion);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions using custom snippets css and unit aliases', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            const testCases = [
            ...
            testCases.forEach(([content, positionLine, positionChar, expectedAbbr, expectedExpansion, expectedFilterText]) => {
                const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.css', 'css', 0, content);
                const position = vscode_languageserver_types_1.Position.create(positionLine, positionChar);
                const completionList = emmetHelper_1.doComplete(document, position, 'css', {
                    preferences: {
                ...
                assert_1.default.equal(completionList.items[0].label, expectedAbbr);
                assert_1.default.equal(completionList.items[0].documentation, expectedExpansion);
                assert_1.default.equal(completionList.items[0].filterText, expectedFilterText);
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide both custom and default snippet completion when partial match with custom snippet', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            const expandOptions = {
                preferences: {},
                showExpandedAbbreviation: 'always',
            ...
            const completionList1 = emmetHelper_1.doComplete(vscode_languageserver_types_1.TextDocument.create('test://test/test.css', 'css', 0, 'm'), vscode_languageserver_types_1.Position.create(0, 1), 'css', expandOptions);
            assert_1.default.equal(completionList1.items.findIndex(x => x.label === 'margin: ;') > -1, true);
            assert_1.default.equal(completionList1.items.findIndex(x => x.label === 'mrgstart') > -1, true);
            const completionList2 = emmetHelper_1.doComplete(vscode_languageserver_types_1.TextDocument.create('test://test/test.css', 'css', 0, 'mr'), vscode_languageserver_types_1.Position.create(0, 2), 'css', expandOptions);
            assert_1.default.equal(completionList2.items.findIndex(x => x.label === 'margin-right: ;') > -1, true);
            assert_1.default.equal(completionList2.items.findIndex(x => x.label === 'mrgstart') > -1, true);
            const completionList3 = emmetHelper_1.doComplete(vscode_languageserver_types_1.TextDocument.create('test://test/test.css', 'css', 0, 'mrg'), vscode_languageserver_types_1.Position.create(0, 3), 'css', expandOptions);
            assert_1.default.equal(completionList3.items.findIndex(x => x.label === 'margin-right: ;') > -1, true);
    ...
    mocha_1.it('should not provide completions as they would noise when typing (html)', () => {
        return updateExtensionsPath(null).then(() => {
            ...
            testCases.forEach(([content, positionLine, positionChar]) => {
                ...
                assert_1.default.equal(!completionList, true, (completionList && completionList.items.length > 0) ? completionList.items[0].label + ' shouldnt show up' : 'All good');
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should not provide completions as they would noise when typing (css)', () => {
        return updateExtensionsPath(null).then(() => {
            const testCases = [
                ['background', 0, 10],
                ['font-family', 0, 11],
            ...
            testCases.forEach(([content, positionLine, positionChar]) => {
                ...
                assert_1.default.equal(!completionList || !completionList.items || !completionList.items.length, true, (completionList && completionList.items.length > 0) ? completionList.items[0].label + ' shouldnt show up' : 'All good');
            });
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions for loremn with n words', () => {
        return updateExtensionsPath(null).then(() => {
            ...
            assert_1.default.equal(completionList.items[0].label, 'lorem10.item');
            assert_1.default.equal(matches != null, true);
            assert_1.default.equal(matches[1].split(' ').length, 10);
            assert_1.default.equal(matches[1].startsWith('Lorem'), true);
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions for lorem*n with n lines', () => {
        return updateExtensionsPath(null).then(() => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, 'lorem*3');
            const position = vscode_languageserver_types_1.Position.create(0, 12);
            const completionList = emmetHelper_1.doComplete(document, position, 'html', {
                preferences: {},
                showExpandedAbbreviation: 'always',
            ...
            assert_1.default.equal(completionList.items[0].label, 'lorem*3');
            assert_1.default.equal(expandedText.split('\n').length, 3);
            assert_1.default.equal(expandedText.startsWith('Lorem'), true);
            return Promise.resolve();
        });
    });
    mocha_1.it('should provide completions using vendor prefixes', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            const testCases = [
            ...
            testCases.forEach(([content, positionLine, positionChar, expectedLabel, expectedExpansion, expectedFilterText]) => {
                ...
                assert_1.default.equal(completionList.items[0].label, expectedLabel);
                assert_1.default.equal(completionList.items[0].documentation, expectedExpansion);
                assert_1.default.equal(completionList.items[0].filterText, expectedFilterText);
            });
            return Promise.resolve();
    ...
    mocha_1.it('should provide completions using vendor prefixes with custom preferences', () => {
        return updateExtensionsPath(extensionsPath).then(() => {
            const testCases = [
                ['brs', 0, 3, 'border-radius: ;', 'border-radius: |;', 'brs'],
                ['brs5', 0, 4, 'border-radius: 5px;', 'border-radius: 5px;', 'brs5'],
    ...
    mocha_1.it('should expand with multiple vendor prefixes', () => {
        return updateExtensionsPath(null).then(() => {
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('brs', emmetHelper_1.getExpandOptions('css', {})), 'border-radius: ${0};');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('brs5', emmetHelper_1.getExpandOptions('css', {})), 'border-radius: 5px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('brs10px', emmetHelper_1.getExpandOptions('css', {})), 'border-radius: 10px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-brs', emmetHelper_1.getExpandOptions('css', {})), '-webkit-border-radius: ${0};\n-moz-border-radius: ${0};\nborder-radius: ${0};');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-brs10', emmetHelper_1.getExpandOptions('css', {})), '-webkit-border-radius: 10px;\n-moz-border-radius: 10px;\nborder-radius: 10px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-bdts', emmetHelper_1.getExpandOptions('css', {})), '-webkit-border-top-style: ${0};\n-moz-border-top-style: ${0};\n-ms-border-top-style: ${0};\n-o-border-top-style: ${0};\nborder-top-style: ${0};');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-bdts2px', emmetHelper_1.getExpandOptions('css', {})), '-webkit-border-top-style: 2px;\n-moz-border-top-style: 2px;\n-ms-border-top-style: 2px;\n-o-border-top-style: 2px;\nborder-top-style: 2px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-p10-20', emmetHelper_1.getExpandOptions('css', {})), '-webkit-padding: 10px 20px;\n-moz-padding: 10px 20px;\n-ms-padding: 10px 20px;\n-o-padding: 10px 20px;\npadding: 10px 20px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-p10p20', emmetHelper_1.getExpandOptions('css', {})), '-webkit-padding: 10% 20px;\n-moz-padding: 10% 20px;\n-ms-padding: 10% 20px;\n-o-padding: 10% 20px;\npadding: 10% 20px;');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-mo-brs', emmetHelper_1.getExpandOptions('css', {})), '-moz-border-radius: ${0};\n-o-border-radius: ${0};\nborder-radius: ${0};');
            return Promise.resolve();
        });
    });
    mocha_1.it('should expand with default vendor prefixes in properties', () => {
        return updateExtensionsPath(null).then(() => {
            ...
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-brs', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.oProperties': 'padding', 'css.webkitProperties': 'padding', 'css.mozProperties': '', 'css.msProperties': '' } })), '-webkit-border-radius: ${0};\n-moz-border-radius: ${0};\n-ms-border-radius: ${0};\n-o-border-radius: ${0};\nborder-radius: ${0};');
            assert_1.default.equal(emmetHelper_1.expandAbbreviation('-o-p', emmetHelper_1.getExpandOptions('css', { preferences: { 'css.oProperties': 'padding', 'css.webkitProperties': 'padding' } })), '-o-padding: ${0};\npadding: ${0};');
            return Promise.resolve();
        });
    });
    mocha_1.it('should not provide completions for exlcudedLanguages', () => {
        return updateExtensionsPath(null).then(() => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, 'ul>li');
            ...
            assert_1.default.equal(!completionList, true);
        });
    });
    mocha_1.it('should provide completions with kind snippet when showSuggestionsAsSnippets is enabled', () => {
        return updateExtensionsPath(null).then(() => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, 'ul>li');
            const position = vscode_languageserver_types_1.Position.create(0, 5);
            const completionList = emmetHelper_1.doComplete(document, position, 'html', {
            ...
            assert_1.default.equal(completionList.items[0].kind, vscode_languageserver_types_1.CompletionItemKind.Snippet);
        });
    });
    mocha_1.it('should not provide double completions for commonly used tags that are also snippets', () => {
        return updateExtensionsPath(null).then(() => {
            const document = vscode_languageserver_types_1.TextDocument.create('test://test/test.html', 'html', 0, 'abb');
            ...
            assert_1.default.equal(completionList.items.length, 1);
            assert_1.default.equal(completionList.items[0].label, 'abbr');
        });
    });
});
