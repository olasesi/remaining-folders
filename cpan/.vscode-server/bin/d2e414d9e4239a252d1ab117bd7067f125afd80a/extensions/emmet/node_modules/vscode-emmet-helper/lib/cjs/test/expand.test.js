...
mocha_1.describe('Expand Abbreviations', () => {
    function testExpand(syntax, abbrev, expanded) {
        mocha_1.it(`should expand ${abbrev} to ${expanded}`, () => __awaiter(this, void 0, void 0, function* () {
            const document = vscode_languageserver_types_1.TextDocument.create(`test://test/test.${syntax}`, syntax, 0, abbrev);
            ...
            assert_1.default.equal(expanded, vscode_languageserver_types_1.TextDocument.applyEdits(document, [completionList.items[0].textEdit]));
        }));
    }
