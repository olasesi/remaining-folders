...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            //*********added 26/08/2019**********************//
            if($product_info['from_abroad'] AND $product_info['from_abroad'] == "YES"){
                $data['from_abroad'] = $product_info['from_abroad'];
                $data['del_date'] = date("D M j Y", strtotime("+21 Days"));
                $data['del_dateb'] = date("D M j Y", strtotime("+22 Days"));
                $str_del_date = explode(" ",$data['del_date']);
                if($str_del_date[0] == "Sat"){
                    $data['del_date'] = date("D M j Y", strtotime("+23 Days"));
                    $data['del_dateb'] = date("D M j Y", strtotime("+24 Days"));
                }elseif($str_del_date[0] == "Sun"){
                    $data['del_date'] = date("D M j Y", strtotime("+22 Days"));
                    $data['del_dateb'] = date("D M j Y", strtotime("+23 Days"));

                }
                
            }else{
                $data['from_abroad'] = 'NO';
                $data['del_date'] = date("D M j Y", strtotime("+1 Days"));
                $data['del_dateb'] = date("D M j Y", strtotime("+2 Days")); 
                $str_del_date = explode(" ",$data['del_date']);
                if($str_del_date[0] == "Sat"){
                    $data['del_date'] = date("D M j Y", strtotime("+3 Days"));
                    $data['del_dateb'] = date("D M j Y", strtotime("+4 Days"));
                }elseif($str_del_date[0] == "Sun"){
                    $data['del_date'] = date("D M j Y", strtotime("+2 Days"));
                    $data['del_dateb'] = date("D M j Y", strtotime("+3 Days"));
			...
			foreach ($results as $result) {
                ...
                'date_end'       => $date_end,
					...
					'from_abroad' => $result['from_abroad']
				);
			}
