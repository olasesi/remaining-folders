...
class ControllerCheckoutConfirm extends Controller {
    ...
    //     $subject = "Checkout Test: Thank You";

    //     $mheaders .= "From: sales@obejor.com" . "\r\n"; //$_REQUEST['email'];
    //     $mheaders .= "Reply-To: sales@obejor.com" . "\r\n";
		//end emailing
...
//             //added for emailing 09/11/2019
		...
		// $message .= "Total: " . $product['price'] * $product['quantity'] . " <br />";
		...
		//$message .= "Testing for confirm checkout <br />";
		// //**End emailing
		//**Emailing 09/11/2019
		//$message .= "</div>";
		//mail("emmanuel@miratechnologiesng.com,ici@miratechnologiesng.com,icisystemng@gmail.com",$subject,$message, $mheaders);        
		//**end emailing
